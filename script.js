...
const pronouns = [
    ...
    { ar: "هَا", en: "her", bn: "সে (স্ত্রী)", posEn: "her", posBn: "তার (স্ত্রী)" },
    { ar: "هُمَا ", en: "them (2/f)", bn: "তারা (২ জন/স্ত্রী)", posEn: "their (f/2)", posBn: "তাদের (২ জন/স্ত্রী)" },
    { ar: "هُنَّ", en: "them (f)", bn: "তারা (স্ত্রী)", posEn: "their (f)", posBn: "তাদের (স্ত্রী)" },
    ...
    { ar: "كِ", en: "you (f)", bn: "তুমি (স্ত্রী)", posEn: "your (f)", posBn: "তোমার (স্ত্রী)" },
    { ar: "كُمَا ", en: "you (2/f)", bn: "তোমরা (২ জন/স্ত্রী)", posEn: "your (f/2)", posBn: "তোমাদের (২ জন/স্ত্রী)" },
    { ar: "كُنَّ", en: "you (f/pl)", bn: "তোমরা (স্ত্রী)", posEn: "your (f/pl)", posBn: "তোমাদের (স্ত্রী)" },
